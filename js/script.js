...
function initPartnersCarousel() {
    ...
    if (typeof websiteData !== 'undefined' && websiteData.partners) {
        ...
        partnerData = [
            { name: "TechCorp", logo: "assets/partner-1.png" },
            { name: "InnovateLabs", logo: "assets/partner-2.png" },
            { name: "FutureWorks", logo: "assets/partner-3.png" },
            { name: "NextGen", logo: "assets/partner-4.png" },
            { name: "GlobalTech", logo: "assets/partner-5.png" },
            { name: "SmartSolutions", logo: "assets/partner-6.png" }
        ];
    }
...
function initVideoHover() {
    const videoContainer = document.querySelector('.problem__media-container');
    const playButton = document.querySelector('.problem__play-button');
    const video = document.querySelector('.problem__video');
    const hint = document.querySelector('.problem__hover-hint');
